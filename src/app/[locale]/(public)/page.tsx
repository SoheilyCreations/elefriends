            ...
            <section ref={heroRef} className="relative h-[100dvh] flex flex-col justify-start overflow-hidden">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <h1 className="text-5xl md:text-8xl lg:text-[10rem] font-black tracking-tighter mb-4 text-white uppercase leading-[0.75] drop-shadow-[0_25px_60px_rgba(0,0,0,0.8)]">
                            Wild<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600 italic px-4 -ml-4 drop-shadow-none">Spirits</span><br />
                            Untamed
                        </h1>
                        ...
                        >
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <div className="text-gray-200 font-bold text-xs uppercase tracking-[0.2em] text-center whitespace-nowrap leading-tight">Sightings<br />Accuracy</div>
